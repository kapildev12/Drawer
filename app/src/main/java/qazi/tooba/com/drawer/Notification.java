...
public class Notification extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_hopistals:
                ...
                Toast.makeText(Notification.this, "Showing Nearby Hospitals", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_schools:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Notification.this, "Showing Nearby Pharmacies", Toast.LENGTH_SHORT).show();
                break;
